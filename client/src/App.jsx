...
function HowItWorksPage({ currentUser, skills, onClose, onConnect }) {
  ...
  return <div className="how-it-works-page">
    ...
    <section className="how-ctas"><h2>Ready to make something useful move?</h2><div><button className="button button-dark" onClick={() => goTo('explore')}>Explore skills <ArrowUpRight size={16} /></button><button className="button button-light" onClick={() => goTo('people')}>Find people <UsersRound size={16} /></button>{!currentUser && <button className="text-button" onClick={() => onClose()}>Create profile <ArrowUpRight size={16} /></button>}</div></section>
