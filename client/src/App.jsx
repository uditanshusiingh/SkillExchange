...
function AuthGate({ onLogin }) {
  ...
  const resendVerification = async () => {
    ...
    if (!email) { setVerificationStatus('Enter your email first.'); return; }
  ...
  <button type="button" className="resend-verification-link" onClick={resendVerification} disabled={loading || verificationLoading}>
